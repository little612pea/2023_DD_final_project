...
HD_PWD='D:/FPGA-MAZE-2023DD-final/FPGA-MAZE-vivado/FPGA-MAZE-vivado.runs/welcome_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log welcome_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source welcome_rom.tcl
