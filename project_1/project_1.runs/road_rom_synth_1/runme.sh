...
HD_PWD='D:/FPGA-MAZE-2023DD-final/FPGA-MAZE-vivado/FPGA-MAZE-vivado.runs/road_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log road_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source road_rom.tcl
