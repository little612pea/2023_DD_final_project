...
HD_PWD='D:/FPGA-MAZE-2023DD-final/FPGA-MAZE-vivado/FPGA-MAZE-vivado.runs/award_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log award_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source award_rom.tcl
