...
HD_PWD='D:/FPGA-MAZE-2023DD-final/FPGA-MAZE-vivado/FPGA-MAZE-vivado.runs/wall_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wall_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wall_rom.tcl
